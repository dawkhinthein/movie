export function renderAdmin() {
  ...
  <head>
    ...
    <style>
      ...
      /* 🔥 VIP Gen Styles */
      .vip-gen { background:#222; padding:15px; margin-bottom:20px; border-radius:8px; display:flex; flex-wrap:wrap; gap:10px; align-items:center; border:1px solid #444; }
  ...
  <body>
    ...
    <div id="dashboard" style="display:none;">
      ...
      <div class="vip-gen">
         ...
         <input type="text" id="outCode" readonly style="flex:1; min-width:120px; margin:0; text-align:center; color:#ffd700; font-weight:bold; letter-spacing:1px;" placeholder="Result">
      ...
      <div class="main-grid">
        ...
        <div class="card-box">
          ...
          <div style="margin-top:10px; display:flex; align-items:center; gap:10px; background:#333; padding:10px; border-radius:4px;">
              <input type="checkbox" id="isPremium" style="width:auto; margin:0;">
              <span style="color:#ffd700; font-weight:bold;">Is Premium Content? 👑</span>
          </div>
    ...
    <script>
      ...
      async function genCode() {
          ...
          showToast("Code Generated for " + days + " days");
      }
      ...
      function addSeasonBox(name = "", links = "") {
        ...
        div.innerHTML = \`
            ...
            <label>Links</label>
            <textarea class="s-links" rows="3" placeholder="Paste links...">\${links}</textarea>
        \`;
      ...
      async function loadList(cat) {
        ...
        try {
            ...
            document.getElementById('contentList').innerHTML = '<p style="color:red; text-align:center;">Error</p>';
        }
      }
        ...
        document.getElementById('contentList').innerHTML = data.map(m => \`
          <div class="item">
            ...
            <div style="flex:1">
                ...
                <small>\${m.category} • \${(m.episodes && m.episodes.length) || 1} Eps</small>
            </div>
