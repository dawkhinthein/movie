  ...
  <head>
    ...
    <style>
      ...
      * { box-sizing: border-box; }
      ...
      .tab { flex: 1; padding: 10px; text-align: center; cursor: pointer; color: #777; background: #1a1a1a; font-weight: bold; }
      ...
      <div class="main-grid">
        ...
        <div class="card-box" id="uploadPanel">
          ...
          <div style="margin-top:10px; display:flex; align-items:center; gap:10px; background:#2a2a2a; padding:10px; border-radius:4px;">
              ...
              <span style="color:#ffd700; font-weight:bold;">Premium Content? 👑</span>
          </div>
      ...
      function renderUsers(list) {
          document.getElementById('contentList').innerHTML = list.map(u => {
              ...
              if(isVip) {
                  ...
                  const date = new Date(u.vipExpiry).toLocaleDateString('en-GB'); // DD/MM/YYYY
              ...
              return \`
                <div class="item" style="display:block;">
                    ...
                    <div style="display:flex; gap:5px; margin-top:8px;">
                        ...
                        <button class="btn-blue" style="width:auto; margin:0; font-size:12px;" onclick="resetPass('\${u.username}')">Reset</button>
                    </div>
                </div>\`;
          }).join('');
      }
