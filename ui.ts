export function renderWebsite() {
  ...
  <body>
    ...
    <script>
      ...
      // 🔥 FIX: DISPLAY NONE INITIALLY, FLEX ON PLAY
      ...
      function resetPlayerUI(){
          ...
          document.getElementById('playerOverlay').style.display='none'; // Hidden until play
      }
