export function renderWebsite() {
  ...
  <head>
    ...
    <style>
      ...
      /* 🔥 Search Button Style */
      .search-btn { cursor: pointer; padding: 5px; font-size: 16px; transition: 0.2s; border-radius: 50%; }
      ...
      .see-more { color: #aaa; font-size: 11px; cursor: pointer; text-decoration: none; font-weight: bold; }
      ...
      .card:active { transform: scale(0.95); } /* Touch feedback */
      ...
      .back-btn { background: #333; color: white; border: none; padding: 8px 16px; border-radius: 20px; cursor: pointer; display: flex; align-items: center; gap: 5px; font-size: 13px; font-weight: bold;}
      ...
      .accordion { background-color: #222; color: #eee; cursor: pointer; padding: 12px; width: 100%; border: none; text-align: left; outline: none; font-size: 14px; font-weight: bold; border-bottom: 1px solid #333; display: flex; justify-content: space-between; margin-top: 5px; border-radius: 4px; }
      .accordion.active { background-color: #333; color: #e50914; }
      .panel { padding: 0 5px; background-color: #111; max-height: 0; overflow: hidden; transition: max-height 0.2s ease-out; }
      .episode-grid { display: grid; grid-template-columns: repeat(auto-fill, minmax(60px, 1fr)); gap: 8px; padding: 10px 0; }
  ...
  <body>
    ...
    <script>
      ...
      // 🔥 LOGIC FOR CLICKING SEARCH ICON
