  ...
  <body>
    ...
    <script>
      ...
      window.onload = async () => {
        ...
        // 🔥 URL FIX: Check for "18 " (space) from browser decoding and fix to "18+"
      ...
      // 🔥 AUTO HIDE CONTROLS (CUSTOM ONLY)
      ...
      // 🔥 FIX: INFINITE SCROLL RESET
      function resetGridState() {
          currentPage = 1; isLoading = false; hasMore = true; allMoviesData = []; 
