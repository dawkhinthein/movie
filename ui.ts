    ...
    <div id="playerModal">
      <div class="modal-content">
        ...
        <div class="info-sec">
          ...
          <div class="action-row"><button id="favBtn" class="fav-btn" onclick="toggleFavorite()">🤍 Add to Fav</button><div id="dl_area"></div></div>
    ...
    <script>
      ...
      async function doRedeem() {
          ...
          if(res.ok) {
              ...
              localStorage.setItem('user_session', JSON.stringify(currentUser));
              showAlert("Success!", "VIP Extended.");
              updateProfileUI();
          } else showAlert("Error", "Invalid Code", false);
      }
      ...
      async function openFavorites() {
        showLoader(); showGridInternal(); document.getElementById('gridTitle').innerText = "MY FAVORITES"; document.getElementById('mainGrid').innerHTML = getClientSkeleton(6); document.getElementById('pagControls').style.display = 'none';
